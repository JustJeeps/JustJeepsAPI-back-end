...
async function startRun(feed, { sourceKind, sourceRef, sourceHash, sourceMtime, sourceRowCount, artifactBatchId, startedBy } = {}) {
  const run = await prisma.ingestRun.create({
    data: { feed, sourceKind, sourceRef, sourceHash, sourceMtime, sourceRowCount, artifactBatchId, startedBy },
  });

...
function getPool() {
  ...
  // O pg tambem parseia sslmode da URL e SOBREPOE o objeto `ssl` explicito
  // (ligando verificacao de cadeia que a CA da DO nao passa). Removemos o
  // sslmode da URL e mandamos apenas a config ssl construida acima.

...
- Comment notification email: sent on each new comment to the requester, all followers and all assignees (deduped). Kill switch `REQUESTS_COMMENT_EMAIL_ENABLED=false`.
